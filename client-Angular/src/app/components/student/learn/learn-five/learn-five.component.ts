...
@Component({
  selector: 'app-learn-five',
  templateUrl: './learn-five.component.html',
  styleUrls: ['./learn-five.component.scss']
})
export class LearnFiveComponent implements OnInit {
  ...
  //Router of learn six
  nextLevel(){
    this.studentService.routerLearnSix();
  }
